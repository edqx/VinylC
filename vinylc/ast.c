...
AST_ELEM_GET_LITERAL_FUNCTION(func_decl_stmt, type) AST_ELEM_GET_LITERAL_FUNCTION_IMPL(AST_NODE_KIND_FUNCTION_DECL_STMT, 0);
AST_ELEM_GET_FUNCTION(func_decl_stmt, ref) AST_ELEM_GET_FUNCTION_IMPL(AST_NODE_KIND_FUNCTION_DECL_STMT, 1);
AST_ELEM_GET_FUNCTION(func_decl_stmt, formal_params) AST_ELEM_GET_FUNCTION_IMPL(AST_NODE_KIND_FUNCTION_DECL_STMT, 2);
AST_ELEM_GET_FUNCTION(func_decl_stmt, ret_type) AST_ELEM_GET_FUNCTION_IMPL(AST_NODE_KIND_FUNCTION_DECL_STMT, 3);
AST_ELEM_GET_FUNCTION(func_decl_stmt, impl) AST_ELEM_GET_FUNCTION_IMPL(AST_NODE_KIND_FUNCTION_DECL_STMT, 4);
...
AST_ELEM_GET_FUNCTION(return, expr) AST_ELEM_GET_FUNCTION_IMPL(AST_NODE_KIND_RETURN_STMT, 0);
